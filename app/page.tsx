    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Outbound caller bullpen</p>
          <h1>Outsourced Callers: a caller bullpen for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced callers guide for sales and service teams needing trained callers for follow-up and appointment setting. The page now uses a distinct bold startup layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>call waves and contact strips</figcaption></figure>
      </div>
    </section>
