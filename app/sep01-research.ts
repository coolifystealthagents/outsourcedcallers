type Topic = {slug:string; title:string; excerpt:string; question:string; unit:string; contrast:string; owner:string; limitation:string};
...
export const sep01ResearchPosts = topics.map((topic) => ({slug:topic.slug,title:topic.title,excerpt:topic.excerpt,published:'2026-09-01',image:'/thank-you-hero.png',body:makeBody(topic)}));
