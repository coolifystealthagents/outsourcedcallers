...
import { aug19BlogPosts, makeAug19Detail } from './aug19-blog';
...
for (const post of aug19BlogPosts) {
  blogDetailRecord[post.slug] = makeAug19Detail(post);
}
