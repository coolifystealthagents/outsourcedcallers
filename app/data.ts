...
import { sep04BlogPosts, sep04BlogDetails } from './sep04-blog';
import { sep04ResearchPosts } from './sep04-research';
import { sep07BlogPosts, sep07BlogDetails } from './sep07-blog';
import { sep07ResearchPosts } from './sep07-research';
import { sep08BlogPosts, sep08BlogDetails } from './sep08-blog';
import { sep08ResearchPosts } from './sep08-research';
import { sep09BlogPosts, sep09BlogDetails } from './sep09-blog';
import { sep09ResearchPosts } from './sep09-research';
import { sep10BlogPosts, sep10BlogDetails } from './sep10-blog';
import { sep10ResearchPosts } from './sep10-research';
import { sep11BlogPosts, sep11BlogDetails } from './sep11-blog';
...
blogPosts.push(...sep04BlogPosts);
blogPosts.push(...sep07BlogPosts);
blogPosts.push(...sep08BlogPosts);
blogPosts.push(...sep09BlogPosts);
blogPosts.push(...sep10BlogPosts);
blogPosts.push(...sep11BlogPosts);
blogPosts.push(...sep18BlogPosts);
blogPosts.push(...sep22BlogPosts);
blogPosts.push(...sep23BlogPosts);
blogPosts.push(...sep24BlogPosts);
blogPosts.push(...sep25BlogPosts);
...
for (const post of sep04BlogPosts) {
  blogDetailRecord[post.slug] = (sep04BlogDetails as Record<string, unknown>)[post.slug] as never;
}
for (const post of sep07BlogPosts) {
  blogDetailRecord[post.slug] = (sep07BlogDetails as Record<string, unknown>)[post.slug] as never;
}

for (const post of sep08BlogPosts) {
  blogDetailRecord[post.slug] = (sep08BlogDetails as Record<string, unknown>)[post.slug] as never;
}
for (const post of sep09BlogPosts) {
  blogDetailRecord[post.slug] = (sep09BlogDetails as Record<string, unknown>)[post.slug] as never;
}
for (const post of sep10BlogPosts) {
  blogDetailRecord[post.slug] = (sep10BlogDetails as Record<string, unknown>)[post.slug] as never;
}
for (const post of sep11BlogPosts) {
  blogDetailRecord[post.slug] = (sep11BlogDetails as Record<string, unknown>)[post.slug] as never;
}
for (const post of sep18BlogPosts) {
  blogDetailRecord[post.slug] = (sep18BlogDetails as Record<string, unknown>)[post.slug] as never;
}
for (const post of sep22BlogPosts) {
  blogDetailRecord[post.slug] = (sep22BlogDetails as Record<string, unknown>)[post.slug] as never;
}
...
for (const post of sep25BlogPosts) {
  blogDetailRecord[post.slug] = (sep25BlogDetails as Record<string, unknown>)[post.slug] as never;
}
