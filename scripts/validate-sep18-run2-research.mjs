...
const manifest = JSON.parse(fs.readFileSync('.paperclip/daily-content/2026-09-18/research-outaaaaa-60.json', 'utf8'));
assert.equal(manifest.publicationDate, '2026-09-18');
...
for (const entry of manifest.entries) {
  ...
  assert.ok(html.includes('checked 2026-09-18'), `${entry.route} source dates`);
